...
- [Exemplos de utilização](#conta-do-titular)
    ...
    - [Autenticação](#autenticação)
        ...
        - [Autenticar com hash do lojista a partir do parceiro](#autenticar-com-hash-parceiro)
...
Através deste método, o parceiro gera o token para o lojista sem a necessidade de senha, passando apenas o id do lojista que se deseja gerar o token.
